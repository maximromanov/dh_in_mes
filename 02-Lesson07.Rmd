...
This is a CSV file with the following structure:
...
Let's try to convert this [`bibTex` file](./files/settlements.csv) into other formats. Before we begin, however, let's break down this task into smaller tasks and organize them together in some form of `pseudocode`.
