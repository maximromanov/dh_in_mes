...
The main takeaway from this is that you should always be mindful of how you are filtering your data and what strategies you use for plotting it. Line graph can make a false suggestion, when some x-values are missing. A more reliable graph in such cases would be a "lollipop" graph that is shown below --- lollipop graph does not connect observations, thus clearly showing gaps in data.
