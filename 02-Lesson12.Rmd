...
* Dispatch CSV files (you should be able to generate them on your own)
* [Jupyter notebook 01](./files/tm/__tm_dispatch_part01.ipynb)
* [Jupyter notebook 02](./files/tm/__tm_dispatch_part02.ipynb)
