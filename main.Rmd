...
- copy/paste it into the `C:\Windows\System32` folder (`C:\Windows\System32` is a part of the so-called `PATH` --- a series of paths which all Windows command line *check*);
...
2. In a separate markdown file (to be uloaded with the rest of your homework).
