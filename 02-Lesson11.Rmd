...
If everything done correctly, the map may look like this (although an interactive temporary component is an extra):

![](./files/dispatch_1860_to_65.html)
...
dispatchDataUpd["month"] = [
    re.sub("-\d\d$", "", str(i)) for i in dispatchDataUpd["date"]]
# for the dynamic map we need to have dates as strings
