...
## Mapping chronological data

We can also map our geographical data dynamically, if we want to highlight its chronological dimension. Below is the example. [Click here for the interactive graph](./files/us_cities_pop.html).
