...
If everything done correctly, the map may look like this:

...

Or, even like this --- with an interactive temporary component:
...
print(dispatchDataUpd)
```

The final dataframe looks like what you see below. 
