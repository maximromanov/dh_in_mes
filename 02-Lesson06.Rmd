...
- **NB:** you will only need `bash` for this step; after you restart the `Terminal`, you will be back to the default `zsh` (you can also run `exit` command to quit `bash` and return to `zsh`)
